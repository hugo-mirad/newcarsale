<%@ page language="C#" autoeventwireup="true" CodeFile="CentralReport.aspx.cs"  Inherits="CentralReport" %>
...
<body>
    ...
    <div class="wrapper">
                ...
                <ContentTemplate>
                    ...
                    <div class=" box1 box50p">
                        ...
                        <div class="inn" style="height: 36px">
                            <!-- Start  -->
                            <table style="width: 410px; padding: 0px; border-collapse: collapse; height: 40px;
                                margin-left: 15px;">
                                <tr>
                                    ...
                                    <td style="vertical-align: middle; padding-right: 10px;">
                                        <asp:Button ID="BtnQCSearch" runat="server" Text="Search" CssClass="btn btn-warning btn-xs"
        ...
        <div class="content wid1000">
            ...
            <asp:UpdatePanel ID="U12" runat="server">
            <ContentTemplate>
               <table>
                <tr>
                    <td>
                        <h4>
                            <asp:Label ID="Nameoftype" runat="server" Text=""></asp:Label></h4>
                    </td>
                    <td>  <asp:Label ID="lblRes" Font-Size="12px" Font-Bold="true" ForeColor="Black" runat="server"></asp:Label></td>
                    <td>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView Width="1228px" ID="grdAbandInfo" runat="server" CellSpacing="0" CellPadding="0"
                                                ...
                                                ShowHeader="false" OnRowDataBound="grdAbandInfo_RowDataBound" AllowSorting="true"
