<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllCentersReport.aspx.cs"
    Inherits="AllCentersReport" %>
...
<body>
    ...
    <div class="wrapper">
                    ...
                    <ul class="mainUL">
                        ...
                        <li class="parent active"><a href="#">Sales <span class="cert"></span></a>
                            <ul class="sub1">
                                ...
                                <li class="act"><a href="#">Reports <span class="cert"></span></a>
                                    <ul class="sub2">
                                        <li>
                                            <asp:LinkButton ID="AllCentersReports" runat="server" Text="All Centers Report" Enabled="true"
                        ...
                        <li class="parent"><a href="#">Process <span class="cert"></span></a>
                            <ul class="sub1">
                                ...
                                <li>
                                    <asp:LinkButton ID="Payments" runat="server" Text="P               
                                    ayments" Enabled="false" PostBackUrl="~/LiveTransfers.aspx"></asp:LinkButton></li>
                                <li>
                            ...
                            <ul class="sub1">
                                <li><a href="#">Leads <span class="cert"></span></a>
                                    <ul class="sub2">
                                        ...
                                        <asp:LinkButton ID="linDaSales" runat="server" Text="Daily sales Per agent" PostBackUrl="~/DailyAgentSalesReport.aspx"></asp:LinkButton>
                                    </ul>
                                </li>
        ...
        <div class="content wid1000">
            <asp:UpdatePanel ID="updtpnltblGrdcar" runat="server">
                <ContentTemplate>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 105px; padding-top: 17px; padding-left: 10px;">
                                            ...
                                            <asp:UpdateProgress ID="UpdateProgress3" runat="server" AssociatedUpdatePanelID="updbtnSearch"
                                                DisplayAfter="0">
                                                <ProgressTemplate>
                                                    <div id="spinner">
                                                        <h4>
                    ...
                    <div class=" box1 box50p" style="display: none;">
                        <h1 class="hed1 hed2">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="vertical-align: middle; padding: 3px 0">
                                            Payment:
                                            <select name="ddlpaymen" id="ddlpaymen" style="width: 80px;">
                                                <option value="0">All</option>
                                                <option selected="selected" value="1">Pending</option>
                                            </select>
                                            &nbsp;
                                            <input type="submit" name="PaymentChange" value="Change" id="PaymentChange" class="btn btn-sm btn-warning">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="content wid1000">
                    ...
                    <table width="100%">
                        <tr>
                            <td align="left" style="width: 50%;">
                                <h4>
                                    <asp:Label ID="Nameoftype" runat="server"></asp:Label>
                                </h4>
                            </td>
                            <td>
            ...
            <div class="scroll200" style="max-height: 300px; width: 100%" id="maindivdis" runat="server">
                <table style="width: 100%; display: block;" id="tblSales" runat="server">
                    <tr>
                        <td style="vertical-align: top;">
                            <div style="width: 100%;" id="divCarresults" runat="server">
                                <asp:Panel ID="pnl1" Width="100%" runat="server" Style="">
                    ...
                    <tr>
                        <td style="vertical-align: top;">
                            <div style="width: 100%;" id="div3" runat="server">
                                <asp:Panel ID="Panel3" Width="100%" runat="server" Style="">
                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView Width="1408px" ID="grdVerifierData" runat="server" CellSpacing="0"
                                                ...
                                                GridLines="None" ShowHeader="true" OnRowDataBound="grdVerifierData_RowDataBound"
                                                AllowSorting="true" OnSorting="grdVerifierData__Sorting">
                                                <PagerStyle HorizontalAlign="Right" BackColor="#C6C3C6" ForeColor="Black" />
                                                <SelectedRowStyle BackColor="#9471DE" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle CssClass="tbHed" />
                                                <PagerSettings Position="Top" />
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView Width="1228px" ID="grdAbandInfo" runat="server" CellSpacing="0" CellPadding="0"
                                                ...
                                                ShowHeader="true" OnRowDataBound="grdAbandInfo_RowDataBound" AllowSorting="true"
                                                OnSorting="grdAbandInfo_Sorting">
                                                <PagerStyle HorizontalAlign="Right" BackColor="#C6C3C6" ForeColor="Black" />
                                                <SelectedRowStyle BackColor="#9471DE" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle CssClass="tbHed" />
                                                <PagerSettings Position="Top" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Cen Code" SortExpression="Locationname">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lnkAbandonCenterCode" runat="server" Text='<%# Eval("Locationname")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" Width="140px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Agent" SortExpression="SaleAgent">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <asp:GridView Width="1328px" ID="grdTransfersIn" runat="server" CellSpacing="0" CellPadding="0"
                                                CssClass="table table-hover table-striped" AutoGenerateColumns="False" GridLines="None"
                                                ShowHeader="true" OnRowDataBound="grdTransfersIn_RowDataBound">
                                                <PagerStyle HorizontalAlign="Right" BackColor="#C6C3C6" ForeColor="Black" />
                                                <SelectedRowStyle BackColor="#9471DE" Font-Bold="True" ForeColor="White" />
                                                <HeaderStyle CssClass="tbHed" />
                                                <PagerSettings Position="Top" />
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Agent" SortExpression="SaleAgent">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:HiddenField ID="hdnTransAgentCenterCode" runat="server" Value='<%# Eval("LocationId")%>' />
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" Width="140px" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Verifier" SortExpression="VerifierName">
