                                            ...
                                            <table>
                                                <tr>
                                                    <td style="width: 225px;">
                                                        Vehicle Category
                                                        <asp:DropDownList ID="ddlVehicleType" style="padding:5px;"  runat="server" AppendDataBoundItems="true">
                                                    ...
                                                    <td style="padding-top:16px;">
                                                        <asp:Button runat="server" ID="btnGet" Text="Get" CssClass="btn btn-warning btn-sm   "
                                                         style="width:70px;"  OnClick="btnGet_Click"  />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
