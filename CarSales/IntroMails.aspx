                                ...
                                <tr>
                                    <td style="width: 300px; vertical-align: top;">
                                        ...
                                        <asp:TextBox ID="txtEmailAddress" runat="server" TextMode="MultiLine" CssClass="emailAddress"
                                            MaxLength="4000"></asp:TextBox><br /><br />
                                        ...
                                        <asp:UpdatePanel ID="UpdtPnlBtnSend" runat="server">
                                            <ContentTemplate>
                                                ...
                                                <br />
                                                <asp:TextBox ID="txtCnty" runat="server" Style="width: 40px;" />-
                                                <asp:TextBox ID="txtarea" runat="server" Style="width: 40px;" />-
                                                <asp:TextBox ID="txtfax" runat="server" Style="width: 60px;" />
                                               <br /><br />
                                                <asp:Button ID="btnSendFax" runat="server" Text="SendFax" CssClass="btn btn-warning btn-sm"
