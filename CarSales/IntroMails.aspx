    ...
    <script type="text/javascript" language="javascript">
        ...
        debugger
            ...
            return valid;
                ...
                else if(document.getElementById('<%=ddlBrand.ClientID%>').value =="0")
            {
...
//            }
    ...
    <script type="text/javascript" language="javascript">
          function ClosePopup10() {
            $find('<%= MdlPViewPage.ClientID%>').hide();
            return false;
        }
    </script>
   ...
   { 
      ...
      //date = new Date(parseInt(arr[2]), parseInt(arr[0])-1, parseInt(arr[1]) + 1);
        ...
        $('.arrowLeft').click(function(){
         ...
         //  TAbs Script Start  ----------------------------------------
     var indxTab = $('.tabs li.act').index();
     
    $('.tabsContent .tabsContentInn').hide();
    $('.tabsContent .tabsContentInn:eq('+indxTab+')').show();
    
    $('.tabs li a').on('click',function(){
        $('.tabs li').removeClass('act');
        $(this).parent().addClass('act');
        indxTab = $('.tabs li.act').index();
...
<body>
        ...
        <div class="content wid1000">
            <div class=" box1 box100p">
                ...
                <div class="inn">
                    ...
                    <div class="tabs">
                        <ul>
                            <li class="act"><a href="javascript:void(0);">Intro Mail</a></li>
                            <li><a href="javascript:void(0);">Fax</a></li>
                        </ul>
                    </div>
                    <div class="tabsContent">
                        <!-- tabsContentInn 1 Start  -->
                        <div class="tabsContentInn">
                            <div class="inn">
                                    ...
                                    <ContentTemplate>
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td style="width: 300px; vertical-align: top;">
                                                    ...
                                                    <asp:TextBox ID="txtEmailAddress" runat="server" TextMode="MultiLine" CssClass="emailAddress"
                                                        MaxLength="4000"></asp:TextBox><br />
                                                    <br />
                                                    Brand<br />
                                                    <asp:DropDownList ID="ddlBrand" runat="server">
                                                        <asp:ListItem Value="0">select</asp:ListItem>
                                                        <asp:ListItem Value="1">Unitedcarexchange.com</asp:ListItem>
                                                        <asp:ListItem Value="2">Mobicarz.com</asp:ListItem>
                                                    </asp:DropDownList>
                                                    ...
                                                    <asp:UpdatePanel ID="UpdtPnlBtnSend" runat="server">
                                                        <ContentTemplate>
                                                            ...
                                                            <asp:Button ID="btnPreveiew" runat="server" Text="Preview Mail" OnClick="btnPreveiew_Click"
                                                                CssClass="btn btn-warning btn-sm" />
                                                            <br />
                                                            <br />
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                    <%--<input type="button" value="Send" class="btn btn-warning btn-sm" />--%>
                                                </td>
                                                <td style="width: 40px;">
                                                    &nbsp;
                                                </td>
                                                    ...
                                                    <div style="width: 100%;" id="divresults" runat="server">
                                                        <div style="width: 695px; position: relative; padding: 0 3px; height: 1px">
                                                            <asp:UpdatePanel ID="UpdtpnlHeader" runat="server">
                                                                <ContentTemplate>
                                                                    <table class="table table-hover table-striped  MB0 noBorder" cellpadding="0" cellspacing="0"
                                            ...
                                            <asp:Label ID="lblReverBy" runat="server"></asp:Label>--%>
                                                    ...
                                                    <%--<input type="button" value="Refresh" class="btn btn-warning btn-sm" />--%>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                        ...
                        <!-- tabsContentInn 1 End  -->
                        <!-- tabsContentInn 2 Start  -->
                        <div class="tabsContentInn">
                            <div class="inn">
                                <table>
                                    <tr class="sm">
                                        <td style="width: 90px;">
                                            <asp:Label ID="lblCnty" runat="server" Text="CountryCode" />
                                        </td>
                                        <td style="width: 90px;">
                                            <asp:Label ID="lblarea" runat="server" Text="AreaCode" />
                                        </td>
                                        <td style="width: 110px;">
                                            <asp:Label ID="lblfax" runat="server" Text="FaxNumber" />
                                        </td>
                                        <td>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtCnty" runat="server" Style="width: 90%;" />
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtarea" runat="server" Style="width: 90%;" />
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtfax" runat="server" Style="width: 90%;" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btnSendFax" runat="server" Text="SendFax" CssClass="btn btn-warning btn-xs"
                                                OnClick="btnSendFax_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <!-- tabsContentInn 2 End  -->
                    </div>
                    <!-- Tabs End  -->
                    <!-- End  -->
                </div>
    ...
    <div id="AlertUser" class="popup" style="display: block">
        <h4 id="H1">
            Alert
    ...
    <div id="divAskUserType" class="popup" style="display: none">
        <h4 id="H2">
            Select User Type
    ...
    <cc1:ModalPopupExtender ID="MdlPViewPage" runat="server" PopupControlID="divPreview"
        BackgroundCssClass="ModalPopupBG" TargetControlID="HiddenField2" CancelControlID="Button1">
    </cc1:ModalPopupExtender>
    <asp:HiddenField ID="HiddenField2" runat="server" />
    <div id="divPreview" class="popup" style="display: none">
        <h2>
            Mail Preview
            <%--<asp:Button ID="BtnCls" class="cls" runat="server" Text="" BorderWidth="0" OnClick="btnNo_Click" />--%>
            <!-- <div class="cls"> </div> -->
        ...
        <div class="content">
            <asp:UpdatePanel ID="Updatepanl" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="txtdetbox" runat="server" Style="width: 350px; height: 250px;" ReadOnly="true"
                        TextMode="MultiLine"></asp:TextBox>
                    <asp:Button ID="Button1" class="btn" runat="server" Text="Ok" OnClick="btnOK_Click"
