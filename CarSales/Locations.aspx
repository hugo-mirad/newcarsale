...
<body>
                            ...
                            <ul class="sub1">
                                <li class=""><a href="#">Leads <span class="cert"></span></a>
                                    <ul class="sub2">
                                        ...
                                        <li>
                                            <asp:LinkButton ID="LinkButton2" runat="server" Text="Sales" Enabled="true" PostBackUrl="~/CarSalesReportNew.aspx"></asp:LinkButton></li>
                                    </ul>
                                </li>
    ...
    <div id="updateLoc" style="display: none; width: 950px;" class="popup">
     
        <h2>
        <asp:UpdatePanel ID="MdlUpdapanel" runat="server">
        <ContentTemplate>
          <span class="floarL">Center Code:  <asp:Label ID="LinkButton1" runat="server" Style="padding-left: 10px; font-size: 18px;"
                CssClass="underline "></asp:Label></span>  
        </ContentTemplate>
        </asp:UpdatePanel>
                ...
                <ContentTemplate>
                    <table style="width: 96%; margin: 0 auto;">
                        <tr>
                            ...
                            <td>
                          <asp:CheckBoxList ID="LeadsUpload1" runat="server" RepeatDirection="Horizontal">
                          <asp:ListItem Value="1">Used Car Ads</asp:ListItem>
                          <asp:ListItem Value="2">Car Dealer Services</asp:ListItem>
                          <asp:ListItem Value="3">Used RV Ads</asp:ListItem>
                          <asp:ListItem Value="4">Classic Car Ads</asp:ListItem>
                          <asp:ListItem Value="5">Used Truck Ads</asp:ListItem>
                          </asp:CheckBoxList></td>
                        </tr>
                        <tr>
                            <td>
                           ...
                           <td>
                          <asp:CheckBoxList ID="Sales1" runat="server"  RepeatDirection="Horizontal">
                          <asp:ListItem Value="2">UCE</asp:ListItem>
                          <asp:ListItem Value="3">MAR</asp:ListItem>
                          <asp:ListItem Value="4">CRA</asp:ListItem>
                          <asp:ListItem Value="5">URV</asp:ListItem>
                          <asp:ListItem Value="26">Trucks</asp:ListItem>
                          </asp:CheckBoxList></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                          <asp:CheckBoxList ID="CustomerService1" runat="server"  RepeatDirection="Horizontal">
                          <asp:ListItem Value="2">UCE</asp:ListItem>
                          <asp:ListItem Value="3">MAR</asp:ListItem>
                          <asp:ListItem Value="4">CRA</asp:ListItem>
                          <asp:ListItem Value="5">URV</asp:ListItem>
                        ...
                        <tr>
                           ...
                           <td>
                          <asp:CheckBoxList ID="Process1" runat="server"  RepeatDirection="Horizontal">
                          <asp:ListItem Value="2">UCE</asp:ListItem>
                          <asp:ListItem Value="3">MAR</asp:ListItem>
                          <asp:ListItem Value="4">CRA</asp:ListItem>
                          <asp:ListItem Value="5">URV</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td>
                          <asp:CheckBoxList ID="TransfersIn1" runat="server"  RepeatDirection="Horizontal">
                          <asp:ListItem Value="1">Used Car Ads</asp:ListItem>
                          <asp:ListItem Value="2">Car Dealer Services</asp:ListItem>
                          <asp:ListItem Value="3">Used RV Ads</asp:ListItem>
                          <asp:ListItem Value="4">Classic Car Ads</asp:ListItem>
                        ...
                        <tr>
                           ...
                           <td>
                          <asp:CheckBoxList ID="Abondons1" runat="server"  RepeatDirection="Horizontal">
                          <asp:ListItem Value="1">Used Car Ads</asp:ListItem>
                          <asp:ListItem Value="2">Car Dealer Services</asp:ListItem>
                          <asp:ListItem Value="3">Used RV Ads</asp:ListItem>
                          <asp:ListItem Value="4">Classic Car Ads</asp:ListItem>
                        ...
                        <tr>
                           ...
                           <td>
                          <asp:CheckBoxList ID="FreePosts1" runat="server"  RepeatDirection="Horizontal">
                          <asp:ListItem Value="1">Used Car Ads</asp:ListItem>
                          <asp:ListItem Value="2">Car Dealer Services</asp:ListItem>
                          <asp:ListItem Value="3">Used RV Ads</asp:ListItem>
                          <asp:ListItem Value="4">Classic Car Ads</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <ContentTemplate>
                               <asp:Button ID="btnCancel1" runat="server" Text="Cancel" OnClientClick="return ClosePopup11();"  CssClass="btn btn-warning btn-sm">
                                </asp:Button>
                            </ContentTemplate>
                            </asp:UpdatePanel>
