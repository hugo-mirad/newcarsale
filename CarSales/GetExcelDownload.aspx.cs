...
public partial class GetExcelDownload : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (Session["PageDown"] == null || Session["PageDown"].ToString() == "")
            {
                Response.Redirect("Login.aspx");
            }
            else
            {
                if (Session["PageDown"].ToString() == "LeadsDownload")
                {
                    DataSet ds = Session["LeadsDownDataset"] as DataSet;
                    string filename = Session["LeadsdownloadName"].ToString();
                    Session["PageDown"] = null;
                    Session["LeadsDownDataset"] = null;
                    Session["LeadsdownloadName"] = null;
                    Convert(ds, filename);
                }
            }
        }
