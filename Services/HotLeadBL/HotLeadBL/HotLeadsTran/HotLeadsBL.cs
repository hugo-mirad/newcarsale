...
namespace HotLeadBL.HotLeadsTran
{
    ...
    {
        public DataSet SaveSaleStatusData(UserRegistrationInfo objUserRegInfo, string SaleAgentID, int PackageID, decimal DiscountID, int YearOfMake, int MakeModelID, int BodyTypeID, int VehicleConditionID, string DriveTrain, string Price, string Mileage, string ExteriorColor, string InteriorColor, string Transmission,
        string NumberOfDoors, string VIN, string NumberOfCylinder, int FuelTypeID, string Description, string ConditionDescription, string Title, string state, string Ip, string SaleNotes, int LeadStatus, string LastName, int SourceOfPhotosID, int SourceOfDescriptionID,
            int CarID, string UId, int UserPackID, int sellerID, int PostingID, string SaleVerifierID, string SaleEnteredBy, int EmailExists, int Brandurl)
        {
            try
            {
                bool bnew = false;
                ...
                dbDatabase.AddInParameter(dbCommand, "@SaleAgentID", System.Data.DbType.String, SaleAgentID);
                ...
                dbDatabase.AddInParameter(dbCommand, "@SaleVerifierID", System.Data.DbType.String, SaleVerifierID);
                dbDatabase.AddInParameter(dbCommand, "@SaleEnteredBy", System.Data.DbType.String, SaleEnteredBy);
                dbDatabase.AddInParameter(dbCommand, "@EmailExists", System.Data.DbType.Int32, EmailExists);
                dbDatabase.AddInParameter(dbCommand, "@Brandurl", System.Data.DbType.Int32, Brandurl);
        ...
        public DataSet SaveSaleStatusDataForQCEdit(UserRegistrationInfo objUserRegInfo, string SaleAgentID, int PackageID, int DiscountID, int YearOfMake, int MakeModelID, int BodyTypeID, int VehicleConditionID, string DriveTrain, string Price, string Mileage, string ExteriorColor, string InteriorColor, string Transmission,
  string NumberOfDoors, string VIN, string NumberOfCylinder, int FuelTypeID, string Description, string ConditionDescription, string Title, string state, string Ip, string SaleNotes, int LeadStatus, string LastName, int SourceOfPhotosID, int SourceOfDescriptionID,
  int CarID, int UId, int UserPackID, int sellerID, int PostingID, int EmailExists)
        ...
        public bool Perform_LogOut(string UserID, DateTime logOutDate, string LogID, int logStatusId)
        {
            bool returnValue = false;
            string spNameString = string.Empty;
            ...
            try
            {
                ...
                dbDatabase.AddInParameter(dbCommand, "@UserID", DbType.String, UserID);
                dbDatabase.AddInParameter(dbCommand, "@LogoutDate", DbType.DateTime, logOutDate);
                dbDatabase.AddInParameter(dbCommand, "@LogID", DbType.String, LogID);
        ...
        public bool SmartzUpdateFeatures(int CarID, int FeatureID, int Isactive, string TranBy)
        {
            try
            {
                bool bnew = false;
                ...
                dbDatabase.AddInParameter(dbCommand, "@TranBy", System.Data.DbType.String, TranBy);
        ...
        public DataSet GetAllAgentsSalesData(DateTime FromDate, DateTime ToDate, int AgentCenterID, string AgentID)
        {
            try
            {
                DataSet dsUsers = new DataSet();
                ...
                dbDatabase.AddInParameter(dbCommand, "@AgentID", System.Data.DbType.String, AgentID);
                dsUsers = dbDatabase.ExecuteDataSet(dbCommand);
                return dsUsers;
            }
            catch (Exception ex)
        ...
        public DataSet GetAllAgentsSalesDataSearchByPostingId(DateTime FromDate, DateTime ToDate, int AgentCenterID, string AgentID, string search)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet GetAllAgentsSalesDataSearchByPhone(DateTime FromDate, DateTime ToDate, int AgentCenterID, String AgentID, string search)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet GetAllAgentsSalesDataSearchByName(DateTime FromDate, DateTime ToDate, int AgentCenterID, string AgentID, string search)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet GetAllAgentsVerifiesSalesData(DateTime FromDate, DateTime ToDate, int AgentCenterID, string AgentID)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet GetAllAgentsAbandonSalesData(DateTime FromDate, DateTime ToDate, int AgentCenterID, String AgentID)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet GetAllAgentsTransferOutSalesData(DateTime FromDate, DateTime ToDate, int AgentCenterID, string AgentID)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet GetUsersModuleRites_All(string UserID)
        {
            try
            {
                DataSet dsUsers = new DataSet();
...
//        1,1,1,'2014-01-22 06:39:35.700','10',1,1,'Hm104',
//1,1,'121.1.1.1', '112',1,'12324234234','1','12/07',
//'Padma','B','123','19082','Add','hyd','sk',1
        ...
        public DataSet SaveCreditCardData(int PSID1, int PackageID, int CarID, DateTime PaymentScheduledDate, string Amount, int PSStatusID, int PaymentID,
           string LastModifiedBy, int pmntType, int pmntStatus, string IPAddress, string VoiceRecord,  string cardNumber, string cardType,
           string cardExpDt, string cardholderName, string cardholderLastName, string cardCode, string BillingZip, string billingAdd,
            string billingCity, string billingState, int PostingID,int VoiceFileLocation)
        {
            try
            {
                DataSet dsUsers = new DataSet();
        ...
        public DataSet SavePayPalData(int PSID1, int PackageID, int CarID, DateTime PaymentScheduledDate, string Amount, int PSStatusID, int PaymentID,
           string LastModifiedBy, int pmntType, int pmntStatus, string IPAddress, string VoiceRecord, string TransactionID, string PaypalEmail, int PostingID, int VoiceFileLocation)
        {
            try
            {
                DataSet dsUsers = new DataSet();
       ...
       string Amount, string VoiceRecord, int PostingID, DateTime PaymentDate, string TransactionID, string PaypalEmail,
        ...
        public DataSet SaveCheckData(int PSID1, int PackageID, int CarID, DateTime PaymentScheduledDate, string Amount, int PSStatusID, int PaymentID,
           string LastModifiedBy, int pmntType, int pmntStatus, string IPAddress, string VoiceRecord, int PostingID, int bankAccountType, string bankRouting, string bankName,
        ...
        public DataSet UpdateQCStatus(int QCID, string QCNotes, int QCStatusID, int CarID, string QCDoneBy, int postingID)
        {
            try
            {
                DataSet dsUsers = new DataSet();
                ...
                dbDatabase.AddInParameter(dbCommand, "@CarID", System.Data.DbType.Int32, CarID);
                dbDatabase.AddInParameter(dbCommand, "@QCDoneBy", System.Data.DbType.String, QCDoneBy);
                dbDatabase.AddInParameter(dbCommand, "@postingID", System.Data.DbType.Int32, postingID);
                dsUsers = dbDatabase.ExecuteDataSet(dbCommand);
                return dsUsers;
            }
        ...
        public DataSet SaveSaleStatusDataForTransfers(UserRegistrationInfo objUserRegInfo, string SaleAgentID, int PackageID, int YearOfMake, int MakeModelID, int BodyTypeID, int VehicleConditionID, string DriveTrain, string Price, string Mileage, string ExteriorColor, string InteriorColor, string Transmission,
        string NumberOfDoors, string VIN, string NumberOfCylinder, int FuelTypeID, string Description, string ConditionDescription, string Title, string state, string Ip, string SaleNotes, int LeadStatus, string LastName, int SourceOfPhotosID, int SourceOfDescriptionID,
            int CarID, string UId, int UserPackID, int sellerID, int PostingID, int DispositionID, int EmailExists)
        {
            try
            {
                bool bnew = false;
        ...
        public DataSet UpdateUserLogDataTakenField(String UID)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
        ...
        public DataSet SaveSaleStatusDataForMultiCar(UserRegistrationInfo objUserRegInfo, string SaleAgentID, int PackageID, int YearOfMake, int MakeModelID, int BodyTypeID, int VehicleConditionID, string DriveTrain, string Price, string Mileage, string ExteriorColor, string InteriorColor, string Transmission,
     string NumberOfDoors, string VIN, string NumberOfCylinder, int FuelTypeID, string Description, string ConditionDescription, string Title, string state, string Ip, string SaleNotes, int LeadStatus, string LastName, int SourceOfPhotosID, int SourceOfDescriptionID,
         int CarID, string UId, int UserPackID, int sellerID, int PostingID, string SaleVerifierID, string SaleEnteredBy, int EmailExists,int Brandurl)
        {
            try
 ...
 int pmntType, string IPAddress, string VoiceRecord, int VoiceFileLocation, int SendInvoiceID, string InvoiceAttentionTo,
  string SendInvoiceEmail, string billingName, string BillingZip, string billingAdd, string billingCity, string billingState)
        ...
        public DataSet GetUserDefaultRightsForEditing(int RoleId)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_DefaultUserRights1";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@RoleId", System.Data.DbType.String, RoleId);
                dsCarsData = dbDataBase.ExecuteDataSet(dbCommand);
        ...
        public DataSet UpdateDefalutRightsSales(int EMPID, bool LeadsUpload, bool LeadsDownLoad, bool Abondoned, bool FreePackage,
         bool Ticker, bool IntroMail, bool NewEntry, bool Transferin, bool Transferout, bool Center, bool Self, bool SalesAdmin,
            string usertypid, string LogPerson)
        {
            DataSet dsCarsData = new DataSet();
            try
            {
                ...
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_UpdateDefalutRightsSales";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@Rolesid", System.Data.DbType.Int32, EMPID);
        ...
        public DataSet LeadsEmployeeandRights(string Empid, int RoleId, int Locationid, string CreatedBy)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_LeadsEmployeeandRights";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@Empid", System.Data.DbType.String, Empid);
                dbDataBase.AddInParameter(dbCommand, "@RoleId", System.Data.DbType.String, @RoleId);
        ...
        public DataSet InsertProcessRights(string Empid, int RoleId, int Locationid, string CreatedBy)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_InsertProcessRights";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@Empid", System.Data.DbType.String, Empid);
                dbDataBase.AddInParameter(dbCommand, "@RoleId", System.Data.DbType.String, @RoleId);
        ...
        public DataSet InsertExecutiveRights(string Empid, int RoleId, int Locationid, string CreatedBy)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_InsertExecutiveRights";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@Empid", System.Data.DbType.String, Empid);
                dbDataBase.AddInParameter(dbCommand, "@RoleId", System.Data.DbType.String, @RoleId);
        ...
        //Leadsuser Rights Update
        public DataSet UpdateLeadsRightsSales(string EMPID, bool LeadsUpload, bool LeadsAdmin)
        {
            DataSet dsCarsData = new DataSet();
            try
            {
                ...
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_UpdateLeadsRightsSales";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@EMPID", System.Data.DbType.String, EMPID);
                dbDataBase.AddInParameter(dbCommand, "@LeadsUpload", System.Data.DbType.Boolean, LeadsUpload);
        ...
        public DataSet UpdateProcessRightsSales(string EMPID, bool Qc, bool Pay, bool ProcessAdmin, string usertypid, string LogPerson)
        {
            ...
            try
            {
                ...
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_UpdateProcessRightsSales";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@EMPID", System.Data.DbType.String, EMPID);
                dbDataBase.AddInParameter(dbCommand, "@QC", System.Data.DbType.Boolean, Qc);
        ...
        public DataSet UpdateExecutiveRightsSales(string EMPID, bool Executive, string usertypid, string LogPerson)
        {
            ...
            try
            {
                ...
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_UpdateExecutiveRightsSales";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@EMPID", System.Data.DbType.String, EMPID);
                dbDataBase.AddInParameter(dbCommand, "@Executive", System.Data.DbType.Boolean, Executive);
        ...
        public void UpdateCentersList(int ModulesId, int BrandId, int ProductID, int CeneterId, int selectValue)
        {
            try
            {
                string spNameString = string.Empty;
                ...
                dbDataBase.AddInParameter(dbCommand, "@ProductID", System.Data.DbType.Int32, ProductID);
                dbDataBase.AddInParameter(dbCommand, "@CeneterId", System.Data.DbType.Int32, CeneterId);
                dbDataBase.AddInParameter(dbCommand, "@selectValue", System.Data.DbType.Int32, selectValue);
        ...
        public DataSet IsMovedSmarts(int postingid)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USp_IsMovedSmarts";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@postingId", System.Data.DbType.Int32, postingid);
                dsCarsData = dbDataBase.ExecuteDataSet(dbCommand);
        ...
        public void DeleteCentersList(int ModulesId, int BrandId, int ProductID, int CeneterId)
        {
            try
            {
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_DeleteCentersList";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@ModulesId", System.Data.DbType.Int32, ModulesId);
                dbDataBase.AddInParameter(dbCommand, "@BrandId", System.Data.DbType.Int32, BrandId);
        ...
        //Leads information
        public DataSet LeadsInformation(string phoneNo)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME5);
                spNameString = "USP_LeadsInformation";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@phoneNum", System.Data.DbType.String, phoneNo);
                dsCarsData = dbDataBase.ExecuteDataSet(dbCommand);
                return dsCarsData;
            }
            catch (Exception ex)
        ...
        public DataSet Pname(string Make)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                ...
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
                dbDataBase.AddInParameter(dbCommand, "@makename", System.Data.DbType.String, Make);
                dsCarsData = dbDataBase.ExecuteDataSet(dbCommand);
                return dsCarsData;
            }
            catch (Exception ex)
        ...
        //PnameModel USP_GetStoredprocedurecode

        public DataSet PnameModel(string Model)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
        ...
        public DataSet GetStoredprocedurecode(string statename)
        {
            try
            {
                DataSet dsCarsData = new DataSet();
                string spNameString = string.Empty;
                Database dbDataBase = DatabaseFactory.CreateDatabase(Global.INSTANCE_NAME4);
                spNameString = "USP_GetStoredprocedurecode";
                DbCommand dbCommand = null;
                dbCommand = dbDataBase.GetStoredProcCommand(spNameString);
